...
(function (b) {
    b.jgrid = b.jgrid || {};
    b.extend(b.jgrid, {htmlDecode:function (d) {
            ...
            if (!this.grid) {
                var c = b.extend(true, {url:"", height:150, page:1, rowNum:20, rowTotal:null, records:0, pager:"", pgbuttons:true, pginput:true, colModel:[], rowList:[], colNames:[], sortorder:"asc", sortname:"", datatype:"xml", mtype:"GET", altRows:false, selarrrow:[], savedRow:[], shrinkToFit:true, xmlReader:{}, jsonReader:{}, subGrid:false, subGridModel:[], reccount:0, lastpage:0, lastsort:0,
                    ...
                    rownumWidth:25, rownumbers:false, pagerpos:"center", recordpos:"right", footerrow:false, userDataOnFooter:false, hoverrows:true, altclass:"ui-priority-secondary", viewsortcols:[false, "vertical", true], resizeclass:"", autoencode:false, remapColumns:[], ajaxGridOptions:{}, direction:"ltr", toppager:false, headertitles:false, scrollTimeout:40, data:[], _index:{}, grouping:false, groupingView:{groupField:[], groupOrder:[], groupText:[], groupColumnShow:[], groupSummary:[], showSummaryOnHide:false, sortitems:[], sortnames:[], groupDataSorted:false,
                        summary:[], summaryval:[], plusicon:"ui-icon-circlesmall-plus", minusicon:"ui-icon-circlesmall-minus"}, ignoreCase:false, cmTemplate:{}, idPrefix:""}, b.jgrid.defaults, d || {}), h = {headers:[], cols:[], footers:[], dragStart:function (e, f, j) {
                ...
                if (this.tagName.toUpperCase() != "TABLE")alert("Element is not a table"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model);
                            ...
                            if (!a.grid.hDiv.loading) {
                                ...
                                if (b.isFunction(a.p.datatype))a.p.datatype.call(a, a.p.postData, "load_" + a.p.id); else {
                                    ...
                                    switch (m) {
                                        ...
                                        case "xml":
                                        case "script":
                                            b.ajax(b.extend({url:a.p.url, type:a.p.mtype, dataType:m, data:b.isFunction(a.p.serializeGridData) ? a.p.serializeGridData.call(a, a.p.postData) : a.p.postData,
                        ...
                        b(h.bDiv).append(b('<div style="position:relative;' + (y && b.browser.version < 8 ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:a.p.height + (isNaN(a.p.height) ? "" : "px"), width:h.width +
                            "px"}).scroll(h.scrollGrid);
                        ...
                        var Ba = a.p.hidegrid === true ? b("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(
                            function () {
    ...
    b.jgrid.extend({getGridParam:function (d) {
        var i = this[0];
            ...
            if (d !== undefined) {
                ...
                if (!(!k || !k.className || k.className.indexOf("ui-state-disabled") > -1)) {
                    ...
                    if (c.p.multiselect) {
                        ...
                        if (c.p.selrow != k.id) {
                            b(c.rows.namedItem(c.p.selrow)).removeClass("ui-state-highlight").attr({"aria-selected":"false",
                                tabindex:"-1"});
...
(function (b) {
    ...
    b.fn.fmatter.showlink = function (a, c) {
        var d = {baseLinkUrl:c.baseLinkUrl, showAction:c.showAction, addParam:c.addParam || "", target:c.target, idName:c.idName}, f = "";
        b.fmatter.isUndefined(c.colModel.formatoptions) || (d = b.extend({}, d, c.colModel.formatoptions));
        if (d.target)f = "target=" + d.target;
...
(function (a) {
    a.jgrid.extend({getColProp:function (b) {
        ...
        b = a.extend({autosearch:true,
            searchOnEnter:true, beforeSearch:null, afterSearch:null, beforeClear:null, afterClear:null, searchurl:"", stringResult:false, groupOp:"AND", defaultSearch:"bw"}, b || {});
        return this.each(function () {
            function e(d, g) {
                var h = a(d);
            ...
            if (!this.ftoolbar) {
                var j = function () {
                    ...
                    q || a(c).jqGrid("setGridParam", {search:n}).trigger("reloadGrid", [
                        {page:1}
                    ]);
                ...
                a.each(c.p.colModel, function () {
                    ...
                    if (this.search)switch (this.stype) {
                        case "select":
                            if (i =
                                this.surl || f.dataUrl)a.ajax(a.extend({url:i, dataType:"html", success:function (o) {
        ...
        return this.each(function () {
            ...
            if (q.html() === null)q = a("<tr>", {role:"row", "aria-hidden":"true"}).addClass("jqg-first-row-header").css("height", "auto"); else q.empty();
            ...
            for (c = 0; c < m; c++) {
                ...
                if (d >= 0) {
                    ...
                    a("<th>", {role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + e.p.direction).css({display:j.hidden ?
                        "none" : "", "border-top":"0px none"}).insertBefore(h);
                    p.append(g)
                } else {
                    p.append(g);
                    k--
    ...
    a.extend(a.jgrid, {showModal:function (b) {
        ...
        switch (b) {
            ...
            case "select":
                ...
                if (typeof c.dataUrl != "undefined")a.ajax(a.extend({url:c.dataUrl, type:"GET", dataType:"html", context:{elem:e, options:c, vl:d}, success:function (m) {
...
(function (a) {
    ...
    a.jgrid.extend({searchGrid:function (f) {
        ...
        b = a.extend({top:0,
            ...
            savekey:[false, 13], navkeys:[false, 38, 40], checkOnSubmit:false, checkOnUpdate:false, _savedData:{}, processing:false, onClose:null, ajaxEditOptions:{}, serializeEditData:null, viewPagerButtons:true}, a.jgrid.edit, b || {});
        d[a(this)[0].p.id] = b;
        return this.each(function () {
            function e() {
            ...
            var c = this;
            if (c.grid && f) {
                var t = c.p.id, o = "FrmGrid_" + t, i = "TblGrid_" + t, m = {themodal:"editmod" +
                ...
                if (a("#" + m.themodal).html() !== null) {
                    ...
                    a.jgrid.viewModal("#" + m.themodal, {gbox:"#gbox_" +
        ...
        b = a.extend({top:0, left:0, width:0, height:"auto", dataheight:"auto", modal:false, overlay:30, drag:true, resize:true, jqModal:true, closeOnEscape:false, labelswidth:"30%", closeicon:[], navkeys:[false, 38, 40], onClose:null, beforeShowForm:null, beforeInitData:null,
            viewPagerButtons:true}, a.jgrid.view, b || {});
        return this.each(function () {
            function e() {
        ...
        return this.each(function () {
            ...
            if (e.grid)if (f) {
                var q = a.isFunction(d[e.p.id].beforeShowForm), x = a.isFunction(d[e.p.id].afterShowForm), G = a.isFunction(d[e.p.id].beforeInitData) ? d[e.p.id].beforeInitData :
                    false, B = e.p.id, w = {}, n = true, j = "DelTbl_" + B, s, M, c, t, o = {themodal:"delmod" + B, modalhead:"delhd" + B, modalcontent:"delcnt" + B, scrollelm:j};
                ...
                if (a("#" + o.themodal).html() !== null) {
                    ...
                    a.jgrid.viewModal("#" + o.themodal,
                        {gbox:"#gbox_" + B, jqm:d[e.p.id].jqModal, jqM:false, overlay:d[e.p.id].overlay, modal:d[e.p.id].modal})
                } else {
                    ...
                    a("#dData", "#" + j + "_2").click(function () {
                        ...
                        if (m[0] && !d[e.p.id].processing) {
                            ...
                            s[M] = H.join();
                            J = a.extend({url:d[e.p.id].url ? d[e.p.id].url : a(e).jqGrid("getGridParam", "editurl"), type:d[e.p.id].mtype, data:a.isFunction(d[e.p.id].serializeDelData) ?
                                d[e.p.id].serializeDelData(s) : s, complete:function (u, C) {
                                if (C != "success") {
                                    m[0] = false;
                            ...
                            if (m[0])if (d[e.p.id].useDataProxy) {
                                ...
                                } else a.jgrid.hideModal("#" + o.themodal, {gb:"#gbox_" + B, jqm:b.jqModal, onClose:d[e.p.id].onClose})
                            } else a.ajax(J)
                        }
                        if (m[0] === false) {
                            a("#DelError>td", "#" + j).html(m[1]);
                ...
                if (!(!n.grid ||
                    ...
                    for (var M = 0; M < s; M++) {
                        ...
                        if (b.add) {
                            ...
                            a("tr", c).append(j);
                            a(j, c).attr({title:b.addtitle || "", id:q.id || "add_" + o}).click(
                                function () {
                        ...
                        if (b.edit) {
                            ...
                            a("tr", c).append(j);
                            a(j, c).attr({title:b.edittitle || "", id:e.id || "edit_" + o}).click(
                                function () {
                        ...
                        if (b.view) {
                            ...
                            a(j).append("<div class='ui-pg-div'><span class='ui-icon " + b.viewicon + "'></span>" + b.viewtext +
                                "</div>");
                            a("tr", c).append(j);
                            a(j, c).attr({title:b.viewtitle || "", id:B.id || "view_" + o}).click(
                                function () {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var i = n.p.selrow;
                        ...
                        if (b.del) {
                            ...
                            a("tr", c).append(j);
                            a(j, c).attr({title:b.deltitle || "", id:x.id || "del_" + o}).click(
                                function () {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var i;
                                        if (n.p.multiselect) {
                                        ...
                                        if (i)"function" == typeof b.delfunc ? b.delfunc(i) : a(n).jqGrid("delGridRow", i, x); else {
                                            a.jgrid.viewModal("#" + w.themodal, {gbox:"#gbox_" +
                                                n.p.id, jqm:true});
                                            a("#jqg_alrt").focus()
                                        }
                                    }
                        ...
                        if (b.search) {
                            ...
                            a("tr", c).append(j);
                            a(j, c).attr({title:b.searchtitle || "", id:G.id || "search_" + o}).click(
                                function () {
                        ...
                        if (b.refresh) {
                            ...
                            a("tr", c).append(j);
                            a(j, c).attr({title:b.refreshtitle || "", id:"refresh_" + o}).click(
                                function () {
                                    if (!a(this).hasClass("ui-state-disabled")) {
...
(function (c) {
    c.fn.jqFilter = function (k) {
        ...
        var o = c.extend(true, {filter:null, columns:[], onChange:null, afterRedraw:null, checkValues:null, error:false, errmsg:"", errorcheck:true, showQuery:true, sopt:null, ops:[
        ...
        ], numopts:["eq", "ne", "lt", "le", "gt", "ge", "nu", "nn", "in", "ni"], stropts:["eq", "ne", "bw", "bn", "ew", "en", "cn", "nc", "nu", "nn", "in", "ni"], _gridsopt:[], groupOps:[
            {op:"AND", text:"AND"},
            {op:"OR", text:"OR"}
        ], groupButton:true, ruleButtons:true, direction:"ltr"}, k || {});
        return this.each(function () {
            if (!this.filter) {
                this.p = o;
                    ...
                    this.createTableForGroup = function (d, g) {
                        ...
                        if (this.p.groupButton) {
                            ...
                            f.bind("click", function () {
                                ...
                                d.groups.push({groupOp:o.groupOps[0].op, rules:[],
                                    groups:[]});
                                a.reDraw();
                                a.onchange();
                                return false
...
(function (a) {
    ...
    a.jgrid.extend({editRow:function (c, d, b, h, l, n, s, o, f) {
        ...
        m = a.extend(true,
            {keys:false, oneditfunc:null, successfunc:null, url:null, extraparam:{}, aftersavefunc:null, errorfunc:null, afterrestorefunc:null, restoreAfterError:true, mtype:"POST"}, a.jgrid.inlineEdit, m);
        return this.each(function () {
        ...
        f = a.extend(true, {successfunc:null, url:null, extraparam:{}, aftersavefunc:null, errorfunc:null, afterrestorefunc:null, restoreAfterError:true, mtype:"POST"}, a.jgrid.inlineEdit, f);
        ...
        if (o === "1") {
            ...
            if (f.url == "clientArray") {
                ...
                a.ajax(a.extend({url:f.url, data:a.isFunction(g.p.serializeRowData) ? g.p.serializeRowData.call(g, w) : w, type:f.mtype, async:false, complete:function (p, t) {
                    a("#lui_" + g.p.id).hide();
                    if (t === "success") {
                        var u = true, y;
        ...
        c = a.extend(true, {rowID:"new_row", initdata:{}, position:"first", useDefValues:true, useFormatter:false, addRowParams:{extraparam:{}}}, c || {});
        return this.each(function () {
            if (this.grid) {
                var d = this;
        ...
        d =
            a.extend({edit:true, editicon:"ui-icon-pencil", add:true, addicon:"ui-icon-plus", save:true, saveicon:"ui-icon-disk", cancel:true, cancelicon:"ui-icon-cancel", addParams:{useFormatter:false}, editParams:{}}, a.jgrid.nav, d || {});
        return this.each(function () {
            if (this.grid) {
                var b = this;
                if (d.addParams.useFormatter === true) {
                    ...
                    for (l = 0; l < h.length; l++)if (h[l].formatter && h[l].formatter === "actions") {
                        if (h[l].formatoptions) {
                            h = a.extend({keys:false, onEdit:null, onSuccess:null, afterSave:null, onError:null, afterRestore:null,
                                extraparam:{}, url:null}, h[l].formatoptions);
                            d.addParams.addRowParams = {keys:h.keys, oneditfunc:h.onEdit, successfunc:h.onSuccess, url:h.url, extraparam:h.extraparam, aftersavefunc:h.afterSavef, errorfunc:h.onError, afterrestorefunc:h.afterRestore}
                        }
                        break
                    }
                }
                ...
                if (d.cancel) {
                    a(b).jqGrid("navButtonAdd",
                        c, {caption:d.canceltext || "", title:d.canceltitle || "Cancel row editing", buttonicon:d.cancelicon, id:b.p.id + "_ilcancel", onClickButton:function () {
                            var n = b.p.savedRow[0].id;
                            if (n) {
        ...
        return this.each(function () {
            ...
            if (a.p.treeGrid) {
                ...
                if (a.p.treeGridModel == "nested")a.p.treeReader = d.extend({level_field:"level", left_field:"lft", right_field:"rgt", leaf_field:"isLeaf", expanded_field:"expanded", loaded:"loaded", icon_field:"icon"}, a.p.treeReader); else if (a.p.treeGridModel == "adjacency")a.p.treeReader = d.extend({level_field:"level", parent_id_field:"parent", leaf_field:"isLeaf", expanded_field:"expanded",
                    loaded:"loaded", icon_field:"icon"}, a.p.treeReader);
            ...
            if (this.grid && this.p.treeGrid) {
                ...
                if (!a[c]) {
                    ...
                    if (d(this).jqGrid("isNodeLoaded", this.p.data[j])) {
                        ...
                        this.p.treeGridModel == "nested" ? d(this).jqGrid("setGridParam", {postData:{nodeid:l, n_left:a[h], n_right:a[f], n_level:a[g]}}) : d(this).jqGrid("setGridParam",
